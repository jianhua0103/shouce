...
<head>
<meta charset="utf-8">
<title>公积金账户个人信息更改办理流程- 第1页</title>
...
<div class="listtitlewrapper">
    <div class="listtitle"><i></i>公积金账户个人信息更改办理流程</div>
    <div class="search">
        <!--搜索开始-->
        <script>
...
<div class="listlist">
 <p style="LINE-HEIGHT: 37px; TEXT-INDENT: 36px; MARGIN: 0px 0px 8px">
  <span style="FONT-FAMILY: 仿宋_GB2312; FONT-SIZE: 18px">
   <span style="FONT-FAMILY: Calibri">员工填写《公积金个人信息更改表》，经公司盖章后，员工携带身份证原件至北海政务服务中心住房公积金管理中心的业务窗口进行信息修改。
   </span>
  </span>
 </p>
 </div>
