...
<div class="listtitlewrapper">
    <div class="listtitle"><i></i>调动流程</div>
    <div class="search">
        <!--搜索开始-->
        <script>
           ...
           <form name="searchform" action="/ks_inc/index.asp" method="post">
...
<div class="listlist">
<p><img src="../images/theme/diaodong.png" /></p>
<div class="fenye" >    共<span id="totalrecord">1</span>篇  <span id="currpage" style="color:red">1</span>/<span id="totalpage">1</span>页  
