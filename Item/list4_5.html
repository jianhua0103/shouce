...
<div class="listtitlewrapper">
    <div class="listtitle"><i></i>公积金联名卡办理流程</div>
    <div class="search">
        <!--搜索开始-->
        <script>
...
<div class="listlist">
 <p style="LINE-HEIGHT: 37px; MARGIN: 0px 0px 8px">
  <span style="FONT-FAMILY: 仿宋_GB2312; FONT-SIZE: 18px">
   <span style="FONT-FAMILY: Calibri"><strong>1.办理条件：</strong>在本市公积金缴纳满6个月后可申请公积金联名卡办理；<br><strong>2.所需材料：</strong>①身份证复印件1份；②《公积金联名卡申请登记表》；<br><strong>3.时间节点：</strong>每月30日前提交材料。<br><br>备注：①《公积金联名卡申请登记表》填写内容须手写；<br>②如公积金联名卡丢失后员工本人须到对应银行柜台挂失并进行补办。
   </span>
  </span>
 </p>
 </div>
