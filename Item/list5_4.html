...
<div class="listtitlewrapper">
    <div class="listtitle"><i></i>VPN权限申请</div>
    <div class="search">
        <!--搜索开始-->
        <script>
...
<div class="listlist">
 <p style="LINE-HEIGHT: 37px; MARGIN: 0px 0px 8px">
  <span style="FONT-FAMILY: 仿宋_GB2312; FONT-SIZE: 18px">
   <span style="FONT-FAMILY: Calibri"><strong>1.</strong>VPN适用于常驻外地或经常出差的且需要使用集团平台和邮箱的员工。<br><strong>2.</strong>VPN申请方式：需申请VPN权限的员工，请自行填写《vpn权限申请表》并发送至 <a style="color:blue" href="Mailto:helpdesk_it@enn.cn">helpdesk_it@enn.cn</a>。
   </span>
  </span>
 </p>
 </div>
