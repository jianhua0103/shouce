...
<div class="listtitlewrapper">
    <div class="listtitle"><i></i>公积金账户余额查询</div>
    <div class="search">
        <!--搜索开始-->
        <script>
...
<div class="listlist">
 <p style="LINE-HEIGHT: 37px; MARGIN: 0px 0px 8px">
  <span style="FONT-FAMILY: 仿宋_GB2312; FONT-SIZE: 18px">
   <span style="FONT-FAMILY: Calibri"><strong>1.</strong>员工持本人身份证原件至北海政务服务中心住房公积金管理中心的业务窗口进行人工查询。<br><strong>2.</strong>登录北海市住房公积金余额查询系统(网址：<a style="color:blue" href="http://gjj.beihai.gov.cn/">http://gjj.beihai.gov.cn/</a>)，输入姓名、身份证号码、密码（初始密码：000000）即可查询。   
   </span>
  </span>
 </p>
 </div>
