...
<div class="listtitlewrapper">
    <div class="listtitle"><i></i>个人基本信息更新</div>
    <div class="search">
        <!--搜索开始-->
        <script>
...
<div class="listlist">
 <p style="LINE-HEIGHT: 37px; MARGIN: 0px 0px 8px">
  <span style="FONT-FAMILY: 仿宋_GB2312; FONT-SIZE: 19px">
   <span style="FONT-FAMILY: Calibri"><strong>1.</strong>每个月25号部门统一传递信息更新表至邮箱：<a style="color:blue" href="Mailto:weihuan@enn.cn">zengxiaocui@enn.cn</a>。
   </span>
  </span>
 </p>
 </div>
